...
const NewDocumentPage: React.FC = () => {
  ...
  console.log(userId, 'User ID from context');
    ...
    try {
      ...
      const documentData = await apiService.uploadDocument(formData) as any;
      ...
      const qrId = documentData?.qrId; // The qrId is automatically generated by the Document model
      
      if (!documentId) {
        console.error("No document ID found in response:", documentData);
      ...
      // Refresh the document context to include the new document
      await refreshData();
